...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">خیبر</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>فایل های اطلاعاتی</span></a>
                <ul class="ml-menu">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>رصد تیم های اطلاعاتی</span></a>
                <ul class="ml-menu">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>بانک اطلاعاتی</span></a>
                <ul class="ml-menu">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>گزارش اراذل و اوباش</span></a>
                <ul class="ml-menu">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>گزارش سلطنت طلب ها</span></a>
                <ul class="ml-menu">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            @include('aero.indexleaflet')
                            <h2><strong><i class="zmdi zmdi-chart"></i>نقشه </strong>مدیریت جرم</h2>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong><i class="zmdi zmdi-chart"></i> گزارش</strong> درگیری های خیابانی</h2>
            ...
            <div class="row clearfix">
                <div class="col-md-12 col-lg-8">
                    <div class="card">
                        <div class="header">
                            <h2><strong>آمار</strong> حملات سایبری اخیر</h2>
                            <ul class="header-dropdown">
                                <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                    <ul class="dropdown-menu dropdown-menu-right slideUp">
